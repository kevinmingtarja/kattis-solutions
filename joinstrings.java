...
// TailedLinkedList from Prof's lecture
...
public class joinstrings {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<TailedLinkedList> list = new ArrayList<TailedLinkedList>();
        ...
        while (true) {
            ...
            TailedLinkedList first = list.get(a - 1);
            TailedLinkedList second = list.get(b - 1);

            first.tail.next = second.head;
            first.tail = second.tail;
            first.num_nodes += second.size();
            list.set(a - 1, first);

        }
        TailedLinkedList finalList = list.get(a - 1);
        for (int i = 0; i < n; i++) {
            int currIdx = finalList.removeFront();
            pw.print(stringArr[currIdx - 1]);
        }
        pw.close();
    }
}